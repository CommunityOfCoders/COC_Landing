...
export default function AIGroupPage() {
  const badges = [
    { label: "Machine Learning", className: "bg-green-500/10 text-green-300" },
    ...
    { label: "NLP", className: "bg-emerald-500/10 text-emerald-300" },
    { label: "Neural Networks", className: "bg-green-500/10 text-green-300" },
    { label: "Data Science", className: "bg-emerald-500/10 text-emerald-300" },
  ];
